...
function ProtectedRoute({ children, role }) {
  ...
  if (role && user.role !== role) {
    return <Navigate to={user.role === 'teacher' ? '/teacher/classes' : '/student/curriculum'} replace />;
  }
  return children;
}
    ...
    >
      <Routes>
        ...
        <Route
          ...
          element={
            user ? (
              <Navigate to={user.role === 'teacher' ? '/teacher/classes' : '/student/curriculum'} replace />
            ) : (
              <Login />
            )
          }
        ...
        <Route path="/teacher/classes"
          element={<ProtectedRoute role="teacher"><TeacherClasses /></ProtectedRoute>}
        />
        <Route path="/teacher/settings"
          element={<ProtectedRoute role="teacher"><TeacherSettings /></ProtectedRoute>}
        />
        <Route path="/teacher/dashboard"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><TeacherDashboard /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/lessons"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><LessonEditor /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/lessons/:id"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><LessonEditor /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/assignments"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><Assignments /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/submissions"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><Submissions /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/exercises"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><Exercises /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/qna/:lessonId"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><QnA /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/students"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><Students /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/students/:id"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><StudentDetail /></TeacherClassGate></ProtectedRoute>}
        />
        <Route path="/teacher/gradebook"
          element={<ProtectedRoute role="teacher"><TeacherClassGate><Gradebook /></TeacherClassGate></ProtectedRoute>}
        />
        ...
        <Route path="/student/classes"
          element={<ProtectedRoute role="student"><StudentClasses /></ProtectedRoute>}
        />
        <Route path="/student/curriculum"
          element={<ProtectedRoute role="student"><Curriculum /></ProtectedRoute>}
        />
        <Route path="/student/lessons/:id"
          element={<ProtectedRoute role="student"><LessonView /></ProtectedRoute>}
        />
        <Route path="/student/homework"
          element={<ProtectedRoute role="student"><Homework /></ProtectedRoute>}
        />
        <Route path="/student/due"
          element={<ProtectedRoute role="student"><Due /></ProtectedRoute>}
        />
        <Route path="/student/exercises/:id"
          element={<ProtectedRoute role="student"><CodeExercise /></ProtectedRoute>}
        />
        <Route path="/student/qna/:lessonId"
          element={<ProtectedRoute role="student"><QnA /></ProtectedRoute>}
        />
        <Route path="/student/settings"
          element={<ProtectedRoute role="student"><StudentSettings /></ProtectedRoute>}
        />
        <Route path="/student/progress"
          element={<ProtectedRoute role="student"><StudentProgress /></ProtectedRoute>}
        />
