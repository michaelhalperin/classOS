...
export default function Curriculum() {
  ...
  const progress =
    lessons.length > 0 ? Math.round((totalComplete / lessons.length) * 100) : 0;
      ...
      <PageLayout fullWidth>
        <div className="card mx-auto max-w-lg px-4 pt-16 pb-24 text-center sm:pb-28 md:pt-20 md:pb-32">
          ...
          <p className="text-sm text-gray-500">
            Ask your teacher to enroll you in a class — then your curriculum
            will appear here.
          </p>
        </div>
      </PageLayout>
        ...
        <div className="space-y-6 pb-24 sm:space-y-8 sm:pb-28 md:pb-32">
          <header className="border-b border-gray-200/80 pb-5 md:pb-6">
            ...
            <p className="mt-1.5 max-w-2xl text-sm text-gray-600 md:text-base">
              Work through lessons week by week. Open a card to read the lesson
              and mark it complete as you go.
            </p>
          </header>
            ...
            >
              <div className="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:justify-between sm:gap-8 md:p-6">
                <div className="min-w-0 shrink-0 sm:w-44 md:w-52">
                  ...
                  <p className="mt-1 tabular-nums text-3xl font-bold text-gray-900 md:text-4xl">
                    {progress}%
                  </p>
          ...
          {lessons.length === 0 ? (
            ...
            <div className="space-y-6 md:space-y-8">
              {weeks.map((week, weekIdx) => {
                ...
                const weekComplete = weekLessons.filter((l) =>
                  completed.includes(l._id),
                ).length;
                const weekPct =
                  weekLessons.length > 0
                    ? Math.round((weekComplete / weekLessons.length) * 100)
                    : 0;
                        ...
                        <div className="flex min-w-0 items-start gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="mt-0.5 text-sm text-gray-600">
                              ...
                              {weekLessons.length === 1 ? "lesson" : "lessons"}{" "}
                              complete
                              <span className="text-gray-400"> · </span>
                          ...
                          {weekLessons.map((lesson) => {
                            ...
                            return (
                              <motion.div
                                ...
                                variants={
                                  shouldReduce ? undefined : cardVariants
                                }
                                whileHover={
                                  shouldReduce
                                    ? undefined
                                    : { y: -2, transition: snappy }
                                }
                              >
                                <Link
                                  to={studentClassPath(
                                  ...
                                  <div className="mt-3 border-t border-gray-100 pt-3">
                                    <span
                                      className={`text-xs font-semibold ${
                                          ...
                                          ? "text-green-800"
                                          : "text-brand-600 group-hover:underline"
                                      }`}
                                    >
                                      {done
                                        ? "Completed — review"
