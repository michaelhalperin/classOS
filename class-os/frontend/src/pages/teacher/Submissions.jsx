      ...
      <div className="space-y-6 pb-24 sm:space-y-7 sm:pb-28 md:pb-32">
        <header className="border-b border-gray-100 pb-5 md:pb-6">
          ...
          <p className="mt-1 max-w-2xl text-sm text-gray-600">
            Open a row to read code, use AI draft feedback, and save grades. Use
            filters to focus on ungraded work.
          </p>
        </header>
...
function SubmissionRow({ submission }) {
  ...
  const handleAiDraft = async () => {
    ...
    try {
      ...
      setAiError(
        e.response?.data?.message || "AI grading failed — check your API key.",
      );
    } finally {
      setAiLoading(false);
    }
  ...
  const hasContent =
    submission.content || submission.githubLink || submission.feedback;

  return (
    <div
      className={`card overflow-hidden transition-shadow duration-200 ${expanded ? "shadow-md" : "hover:shadow-sm"}`}
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              {hasGrade ? (
                <span
                  className={`font-bold text-lg ${submission.grade >= 70 ? "text-green-600" : "text-red-500"}`}
                >
                  {submission.grade}
              ...
              {!grading && (
                <div className="flex items-center gap-3 pt-1 flex-wrap">
                  <button
                    ...
                    className={
                      hasGrade ? "btn-secondary text-sm" : "btn-primary text-sm"
                    }
                  >
                  ...
                  {hasGrade && (
                    <span
                      className={`text-sm font-semibold ${submission.grade >= 70 ? "text-green-600" : "text-red-500"}`}
                    >
                ...
                {grading && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <span className="text-xs text-gray-400">
                        Fills in a suggested grade + feedback — you can edit
                        before saving
                      </span>
                    </div>
